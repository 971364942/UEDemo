...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Attributes", ReplicatedUsing="OnRep_Health")
	FGameplayAttributeData Health;
	ATTRIBUTE_ACCESSORS(USAttributeSet, Health);
	UFUNCTION()
	void OnRep_Health(const FGameplayAttributeData& OldValue);

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Attributes", ReplicatedUsing="OnRep_MaxHealth")
	FGameplayAttributeData MaxHealth;
	ATTRIBUTE_ACCESSORS(USAttributeSet, MaxHealth);
	UFUNCTION()
	void OnRep_MaxHealth(const FGameplayAttributeData& OldValue);
	
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Attributes", ReplicatedUsing="OnRep_Defense")
	FGameplayAttributeData Defense;
	ATTRIBUTE_ACCESSORS(USAttributeSet, Defense);
	UFUNCTION()
	void OnRep_Defense(const FGameplayAttributeData& OldValue);

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Attributes", ReplicatedUsing="OnRep_Attack")
	FGameplayAttributeData Attack;
	ATTRIBUTE_ACCESSORS(USAttributeSet, Attack);
	UFUNCTION()
	void OnRep_Attack(const FGameplayAttributeData& OldValue);

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Attributes", ReplicatedUsing="OnRep_AttackMultiplier")
