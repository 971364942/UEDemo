...
public:
	...
	ATTRIBUTE_ACCESSORS(USAttributeSet, Physical);
	UFUNCTION()
	...
	ATTRIBUTE_ACCESSORS(USAttributeSet, MaxPhysical);
	UFUNCTION()
	void OnRep_MaxPhysical(const FGameplayAttributeData& OldValue);
	
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Physical", ReplicatedUsing="OnRep_Defense")
	FGameplayAttributeData Defense;
	ATTRIBUTE_ACCESSORS(USAttributeSet, Defense);
	UFUNCTION()
	void OnRep_Defense(const FGameplayAttributeData& OldValue);

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Physical", ReplicatedUsing="OnRep_Attack")
	FGameplayAttributeData Attack;
	ATTRIBUTE_ACCESSORS(USAttributeSet, Attack);
	UFUNCTION()
	void OnRep_Attack(const FGameplayAttributeData& OldValue);

	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category="Physical", ReplicatedUsing="OnRep_AttackMultiplier")
